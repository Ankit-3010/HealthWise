          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-700">
                Based on the provided metrics, our model predicts that you have
                a
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-primary">
          ...
          <p className="text-gray-700">
            ...
            turns food into energy. With diabetes, your body either doesn't make
            enough insulin or can't use the insulin it makes as well as it
            should.
          </p>
        </div>
